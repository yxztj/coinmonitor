...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	else
	{
		...
		if (alreadyExpanded)////collapse it!
		{
            ...
            MarketDetailView* marketDetailView=(MarketDetailView*)[cell.contentView viewWithTag:4];
            [marketDetailView removeFromSuperview];
            [UIView animateWithDuration:.5 animations:^{
                //marketDetailView.frame = CGRectMake(450, 150, 120, 40);
